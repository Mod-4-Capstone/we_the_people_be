...
class WebMock::HttpLibAdapters::PatronAdapter < WebMock::HttpLibAdapter
  def self.build_patron_response(webmock_response, default_response_charset); end
  def self.build_request_signature(req); end
  def self.build_webmock_response(patron_response); end
  def self.disable!; end
  def self.enable!; end
  def self.handle_file_name(req, webmock_response); end
end
class WebMock::HttpLibAdapters::PatronAdapter::WebMockPatronSession < Patron::Session
  def handle_request(req); end
end
